...
<div id="frm-registro">
    ...
    <div id="propietario">
      <div id="frgi-ncuit">
        ...
        <input type="text" disabled="disabled" id="cui" />	
      </div>
      <div id="frgi-propiet">
        <label for="prp">Propietario del Tambo:</label>
        <input type="hidden" id="idp" value="X" />
        <input type="text" id="prp" onkeyup="bsqPropie()" tabindex="3" />	
      </div>
      <div id="frgi-domicll">
        <label for="cll">Domicilio: <em>Calle</em></label>
        <input type="text" disabled="disabled" id="cll" />	
      </div>
      <div id="frgi-domicnr">
        <label for="cnr"><em>Nro</em></label>
        <input type="text" disabled="disabled" id="cnr" />	
      </div>
      <div id="frgi-domicpt">
        <label for="cpt"><em>C.Postal</em></label>
        <input type="text" disabled="disabled" id="cpt" />	
      </div>
      <div id="frgi-domiprt">
        <label for="prt"><em>Partido</em></label>
        <input type="text" disabled="disabled" id="prt" />	
      </div>
      <div id="frgi-domilcl">
        <label for="lcl"><em>Localidad</em></label>
        <input type="text" disabled="disabled" id="lcl" />	
      </div>
      <div id="frgi-domitlf">
        <label for="tlf"><em>Telefax</em></label>
        <input type="text" disabled="disabled" id="tlf" />	
      </div>
      <div id="frgi-domieml">
        <label for="eml"><em>Email</em></label>
        <input type="text" disabled="disabled" id="eml" />	
      </div>
    </div>
    <div id="frgi-nmbtmbo">

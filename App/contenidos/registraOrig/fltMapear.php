...
function ubicar(){
  if (window.opener && !window.opener.closed)
		var crd = document.getElementById('mensaje').innerHTML;
    window.opener.document.ubicar(crd);
  window.close();
}
</script>
  </head>
